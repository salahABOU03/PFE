...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		 ...
		 */
		public function generateMaskNo($maskNo, $width, $frame) {
		 ...
		 */
		 public function newInputItem($mode, $size, $data, $bstream=null) {
		 ...
		 * @return array input item
		 */
		 public function encodeModeNum($inputitem, $version) {
		 ...
		 * @return array input item
		 */
		 public function encodeModeAn($inputitem, $version) {
		 ...
		 * @return array input item
		 */
		 public function encodeMode8($inputitem, $version) {
			$inputitem['bstream'] = array();
		 ...
		 * @return array input item
		 */
		 public function encodeModeKanji($inputitem, $version) {
			$inputitem['bstream'] = array();
		 ...
		 * @return array input item
		 */
		 public function encodeModeStructure($inputitem) {
			$inputitem['bstream'] = array();
		 ...
		 * @return array items
		 */
		 public function insertStructuredAppendHeader($items, $size, $index, $parity) {
		 ...
		 * @return int parity
		 */
		 public function calcParity($items) {
			$parity = 0;
		 ...
		 * @return int bits
		 */
		 public function estimateBitStreamSize($items, $version) {
			$bits = 0;
			if ($version == 0) {
				$version = 1;
			}
		 ...
		 * @return int version
		 */
		 public function estimateVersion($items) {
			$version = 0;
			$prev = 0;
			do {
				$prev = $version;
		 ...
		 */
		 public function createBitStream($items) {
			$total = 0;
		 ...
		 * @return array items
		 */
		 public function convertData($items) {
		 ...
		 * @return array bitstream
		 */
		 public function mergeBitStream($items) {
		 ...
		 * @return array bitstream
		 */
		 public function appendBitstream($bitstream, $append) {
		 ...
		 * @return array bitstream
		 */
		 public function appendNum($bitstream, $bits, $num) {
			if ($bits == 0) {
				return 0;
			}
		 ...
		 * @return array bitstream
		 */
		 public function appendBytes($bitstream, $size, $data) {
			if ($size == 0) {
				return 0;
			}
		 ...
		 */
		 public function bitstreamToByte($bstream) {
			$size = count($bstream);
			if ($size == 0) {
				return array();
			}
		 ...
		 * @return array srctab
		 */
		 public function qrstrset($srctab, $x, $y, $repl, $replLen=false) {
		 ...
		 * @return array frame
		 */
		public function putAlignmentMarker($frame, $ox, $oy) {
			$finder = array(
				"\xa1\xa1\xa1\xa1\xa1",
				"\xa1\xa0\xa0\xa0\xa1",
				"\xa1\xa0\xa1\xa0\xa1",
		...
		* Return block number 1
		 ...
		 * @return parity array
		 */
		 public function encode_rs_char($rs, $data, $parity) {
