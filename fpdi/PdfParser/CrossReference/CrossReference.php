...
class CrossReference
{
     ...
     * @throws PdfTypeException
     */
    public function readXref($offset)
    {
     ...
     * @throws PdfTypeException
     */
    public function initReaderInstance($initValue)
    {
     ...
     * @throws CrossReferenceException
     */
    public function checkForEncryption(PdfDictionary $dictionary)
    {
