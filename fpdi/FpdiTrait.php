...
trait FpdiTrait
{
     ...
     */
    public function setMinPdfVersion($pdfVersion)
    {
     ...
     */
    public function getPdfParserInstance(StreamReader $streamReader)
    {
     ...
     * @return string
     */
    public function getPdfReaderId($file)
    {
        if (\is_resource($file)) {
            $id = (string) $file;
     ...
     * @return PdfReader
     */
    public function getPdfReader($id)
    {
        if (isset($this->readers[$id])) {
